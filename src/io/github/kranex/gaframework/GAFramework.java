...
public class GAFramework {
	...
	public static void main(String[] args) throws NumberFormatException, FileNotFoundException, ScriptException, ClassNotFoundException, SQLException, NoSuchMethodException{
		...
		System.out.println("This is free software, and you are welcome to redistribute it under certain conditions; type `GAFramework -c' for details.\n");
		switch(args[0]){
		case "-w":
	...
	/* TODO desc createDatabaseConnection
	 ...
	 */
	public static Connection createDatabaseConnection(String db)
	 ...
	 * 
	 * @param file javascript genetic script.
	 * @param itter # of iterations.
	 * @param poolSize # of chromosomes in the pool.
	 * @throws FileNotFoundException
	 * @throws ScriptException
	 * @throws SQLException
	 * @throws NoSuchMethodException 
	 */
	public GAFramework(File file, int itter, int poolSize) throws FileNotFoundException, ScriptException, SQLException, NoSuchMethodException {
